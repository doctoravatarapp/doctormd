...
- **VALIDADO — aplicação:** lint, typecheck e build de produção passaram em 2026-08-20; o deployment público e `/api/health` em `https://www.apollomd.com.br` retornaram `status: ok` após a criação de `/admin/episodes` e os últimos ajustes de UX.
