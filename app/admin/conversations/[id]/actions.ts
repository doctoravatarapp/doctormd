...
const done=(conversationId:string)=>{revalidatePath(`/admin/conversations/${conversationId}`);revalidatePath("/admin/alerts");revalidatePath("/admin");redirect(`/admin/conversations/${conversationId}`)};
